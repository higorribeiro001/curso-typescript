...
form.addEventListener('submit', function(event: Event) { //funcao normal permite utilizar o this por ser do escopo local, se fosse arrow-function o this viria do escopo global
